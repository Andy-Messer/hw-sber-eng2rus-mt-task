...
class MTDataset(Dataset):
    def __init__(self, tokenized_source_list, attention_mask_source_list, tokenized_target_list, dev):
        self.tokenized_source_list      = tokenized_source_list
        self.attention_mask_source_list = attention_mask_source_list
    ...
    def __getitem__(self, idx):
        ...
        return source_ids, attention_masks, target_ids
